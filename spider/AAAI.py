...
"""https://dblp.uni-trier.de/db/conf/aaai/aaai2024.html"""


if __name__ == "__main__":
    home_page = "https://dblp.uni-trier.de/db/conf/aaai/aaai2024.html"
    target_prefix_page = ""
    cvpr_spider = AAAI_spider(home_page=home_page, target_prefix_page=target_prefix_page)
    cvpr_spider()