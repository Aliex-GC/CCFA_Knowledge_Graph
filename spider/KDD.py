...
class KDD_spider(Spider):
    def __init__(self, home_page, target_prefix_page, work_root="./", name="KDD", num_workers=5):
        super(KDD_spider, self).__init__(work_root=work_root, name=name, num_workers=num_workers)
...
#kdd 8月
#KDD'23 因果发现、预测和决策研讨会，2023 年 8 月 7 日，美国长滩  7

#ECMLPKDD 元知识转移研讨会，2022 年 9 月 23 日，法国格勒诺布尔 

#v218 v191

if __name__ == "__main__":
    home_page = "http://proceedings.mlr.press/v191/"
    target_prefix_page = ""
    kdd_spider = KDD_spider(home_page=home_page, target_prefix_page=target_prefix_page)
    kdd_spider()